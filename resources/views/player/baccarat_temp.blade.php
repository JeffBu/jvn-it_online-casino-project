...
<body class="bg-custom bg-fixed bg-cover text-yellow-50" onload="getcurrentgame()">
    ...
    <!--content-->
        <div class="m-5 pt-14 text-xl font-semi-bold flex-col w-full">

            <!--livestream-->
            <div class="mb-3 justify-center items-center hidden xl:flex 2xl:hidden">
                <div id="stream-xl" class="w-full"></div>
            </div>
            <div class="mb-3 justify-center items-center hidden 2xl:flex">
    ...
    <script>
                ...
                if(result != null)
                {
                    switch(result)
                    {
                        ...
                        case 2:
                            ...
                            break
                        case 3:
                            $('game-tie').css('display', 'inline-block')
                            resetTable()
                            break
                        default:
                            resetTable()
        ...
        function clearBet()
        {
            ...
            $('#bg-bet-b').css('background', '#404040');
            $('#bg-bet-t').css('background', '#404040');
            $('#bg-bet-p').css('background', '#404040');
            $('#bg-bet-bp').css('background', '#404040');
            $('#bg-bet-pp').css('background', '#404040');
        }
